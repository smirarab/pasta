...
class PastaUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.sate.add_option('blind_after_total_iter', IntUserSetting(name='blind_after_total_iter', default=-1, min=None, max=None, short_name=None, help='Maximum number of iterations that PASTA will run before switching to blind mode. [default: disabled]', subcategory='acceptance'))
