...
class PastaUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.sate.add_option('break_strategy', ChoiceUserSetting(name='break_strategy', default='centroid', choices=['centroid', 'longest','midpoint'], multiple_choices=True, short_name=None, help='The method for choosing an edge when bisecting the tree during decomposition [default: centroid]', subcategory='decomposition'))
