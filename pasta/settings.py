...
class PastaUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.commandline.add_option('job', StringUserSetting(name='job', default='pastajob', short_name='j', help='job name', subcategory=None))
        ...
        self.commandline.add_option('raxml_search_after', BoolUserSetting(name='raxml_search_after', default='False', short_name=None, help='If used, the the completion of the PASTA algorithm will be followed by a tree search using RAxML. This can be useful if a very fast and approximate tree estimator is used during the PASTA algorithm.', subcategory=None))
        ...
        self.commandline.add_option('auto', BoolUserSetting(name='auto', default='False', short_name=None, help='If used, then default values for the max_subproblem_size and tools will be used based on the dataset size. WARNING: using this option can cause PASTA to override some of the other options that you have supplied; we recommend that you run this option with --exportconfig to see the exact set of options that will be used in your analysis.', subcategory=None))
        self.sate.add_option('num_cpus', IntUserSetting(name='num_cpus', default=1, min=1, max=None, short_name=None, help='The number of processing cores that you would like to assign to PASTA.  This number should not exceed the number of cores on your machine.', subcategory='platform'))
        self.sate.add_option('max_mem_mb', IntUserSetting(name='max_mem_mb', default=1024, min=256, max=None, short_name=None, help='The maximum memory available (for the Java heap size when running Java tools)', subcategory='platform'))
        ...
        self.sate.add_option('blind_after_total_time', FloatUserSetting(name='blind_after_total_time', default=-1.0, min=None, max=None, short_name=None, help='Maximum time (in seconds) that PASTA will run before switching to blind mode.', subcategory='acceptance'))
        self.sate.add_option('blind_after_total_iter', IntUserSetting(name='blind_after_total_iter', default=-1, min=None, max=None, short_name=None, help='Maximum number of iterations that PASTA will run before switching to blind mode.', subcategory='acceptance'))
        self.sate.add_option('blind_after_time_without_imp', FloatUserSetting(name='blind_after_time_without_imp', default=-1.0, min=None, max=None, short_name=None, help='Maximum time (in seconds) that PASTA will run without an improvement in likelihood score before switching to blind mode.', subcategory='acceptance'))
        self.sate.add_option('blind_after_iter_without_imp', IntUserSetting(name='blind_after_iter_without_imp', default=-1, min=None, max=None, short_name=None, help='Maximum number of iterations without an improvement in likelihood score that PASTA will run before switching to blind mode.', subcategory='acceptance'))
        ...
        self.sate.add_option('iter_limit', IntUserSetting(name='iter_limit', default=-1, min=None, max=None, short_name=None, help='The maximum number of iteration that the PASTA algorithm will run.  If the number is less than 1, then no iteration limit will be used.', subcategory='termination'))
        ...
        self.sate.add_option('iter_without_imp_limit', IntUserSetting(name='iter_without_imp_limit', default=-1, min=None, max=None, short_name=None, help='The maximum number of iterations without an improvement in score that the PASTA algorithm will run.  If the number is less than 1, then no iteration limit will be used.', subcategory='termination'))
        ...
        self.sate.add_option('return_final_tree_and_alignment', BoolUserSetting(name='return_final_tree_and_alignment', default='True', short_name=None, help='Return the tree and alignment pair from the last iteration (otherwise returns the best tree and alignment pair instead)', subcategory='output'))
