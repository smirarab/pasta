...
class PastaUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.sate.add_option('break_strategy', ChoiceUserSetting(name='break_strategy', default='centroid', choices=['centroid', 'longest','midpoint','mincluster'], multiple_choices=True, short_name=None, help='The method for choosing an edge when bisecting the tree during decomposition [default: centroid]', subcategory='decomposition'))
        ...
        self.sate.add_option('max_subtree_diameter', FloatUserSetting(name='max_subtree_diameter', default=1.3, min=0, max=None, short_name=None, help='The maximum diameter of each subtree. [default: 1.3]', subcategory='decomposition'))
