...
class SateUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.commandline.add_option('trusted', BoolUserSetting(name='trusted', default='False', short_name=None, help='If used, then the data in the input file will not be carefully parsed. Using the trusted option will make the initial parsing a bit faster, but it will lead to more cryptic error messages if the input data is not valid.', subcategory=None))
