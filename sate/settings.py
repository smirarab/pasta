...
class SateUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.commandline.add_option('untrusted', BoolUserSetting(name='untrusted', default='False', short_name=None, help='If used, then the data in the input file will be parsed using a more careful procedure. This will generate more helpful error messages, bu will use more memory and be slower. If this option is omitted, the error messages resulting from invalid input data will be more cryptic.', subcategory=None))
