...
class SateUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.commandline.add_option('aligned', BoolUserSetting(name='aligned', default='True', short_name='a', help='If used, then the input file be will treated as aligned for the purposes of the first round of tree inference (the algorithm will start with tree searching on the input before re-aligning). This option only applies if a starting tree is NOT given.', subcategory=None))
