...
class SateUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.commandline.add_option('max_mem_mb', IntUserSetting(name='max_mem_mb', default=2048, min=1024, max=None, short_name="mb", help='The maximum memory available (for the Java heap size when running Java tools)', subcategory='platform'))
