...
if __name__ == '__main__':
    ...
    parser.add_argument('-informat', nargs='?', default="COMPACT3",
                         help='format of the input file (default: COMPACT3)')
    parser.add_argument('-outformat', nargs='?',  default="FASTA",
                         help='format of the outfile file (default: FASTA)')    
    ...
    parser.add_argument('-namemap', nargs="?", type=argparse.FileType('r'), default="pastajob_temp_name_translation.txt",
                         help='Name of the mapping file generated by pasta (default: pastajob_temp_name_translation.txt)')      
    ...
    for action in args.actions:
        ...
        if action =="rename":
            ...
            namemap=dict(zip((x.strip() for i,x in enumerate(lines) if i%2 == 0),(x.strip() for i,x in enumerate(lines) if i%2 == 1)))
            newalg = Alignment()
